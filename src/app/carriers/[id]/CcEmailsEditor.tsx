...
import { updateCarrierCcEmails } from "../actions";
...
export default function CcEmailsEditor({ carrierId, initialCcEmails }: Props) {
  ...
  function handleSave() {
    ...
    startTransition(async () => {
      try {
        await updateCarrierCcEmails(carrierId, cc);
        setSaved(true);
      } catch (err) {
